...
import com.yourfault.weapon.FlowerOfTruth.FlowerOfTruth_Main;
...
public enum WeaponType {
    ...
    ThouserHand(weapons.THOUSER()::clone, Thouser_Main.class,5,10,20,80.0f, 70.0f, 15.0f,"\ue102","thouserhand"),
    FlowerOfTruth(weapons.FLOWER_OF_TRUTH()::clone, FlowerOfTruth_Main.class,2,10,20,80.0f, 100.0f, 10.0f,"\ue103","flower_of_truth"),;
